...
simulation_result <- ANOVA_power(design_result, alpha_level = alpha_level, nsims = nsims)
...
# the effect for the third group is d = .4 (see below for other situations)
...
alpha1 = .05 
#alpha level for three post hoc one-tailed t-tests Bonferroni correction
alpha2 = .05 
