...
sim_result <- ANOVA_power(design_result, nsims = nsims)
...
string <- "5w"
mu <-
c(0, 0, 0, 0, 5) #All means are equal - so there is no real difference.
...
string <- "6w"
mu <-
c(0, 0, 0, 0, 0, 5) #All means are equal - so there is no real difference.
...
string <- "7w"
mu <-
c(0, 0, 0, 0, 0, 0, 5) #All means are equal - so there is no real difference.
labelnames <-
c("Factor_A", "a1", "a2", "a3", "a4", "a5", "a6", "a7") #
design_result <-
ANOVA_design(
design = string,
n = n,
