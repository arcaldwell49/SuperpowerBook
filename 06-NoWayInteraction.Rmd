...
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_1$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_1$power2,2))
```
```{r eval = FALSE}
  colada17(simtot = 2000, n1 = 50, n2 = 100, d1 = .3, d2 = 0)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_2$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_2$power2,2))
```
```{r eval = FALSE}
  colada17(simtot = 2000, n1 = 150, n2 = 300, d1 = .25, d2 = 0)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_3$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_3$power2,2))
```
...
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_4$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_4$power2,2))
```
```{r eval = FALSE}
  colada17(simtot = 2000, n1 = 50, n2 = 200, d1 = .5, d2 = .3 * .5)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_5$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_5$power2,2))
```
```{r eval = FALSE}
  colada17(simtot = 2000, n1 = 22, n2 = 88, d1 = .41, d2 = .3 * .41)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_6$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_6$power2,2))
```
...
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_7$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_7$power2,2))
```
...
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_8$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_8$power2,2))
```
```{r eval=FALSE}
colada17(simtot = 10000, n1 = 50, n2 = 100, d1 = .3, d2 = 0)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_9$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_9$power2,2))
```
```{r eval = FALSE}
colada17(simtot = 10000, n1 = 150, n2 = 300, d1 = .25, d2 = 0)
```
```{r echo=FALSE}
  cat("\nStudy 1 is powered to:",round(colada_10$power1,2))
  cat("\nStudy 2 is powered to:",round(colada_10$power2,2))
```
