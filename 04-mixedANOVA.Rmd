...
We can simulate a two-way ANOVA with a specific alpha, sample size and effect size, to achieve a specified statistical power. We will try to reproduce the power analysis by G*Power [@faul2007g] for an F-test from an ANOVA with a repeated measures, within-between interaction effect. 
