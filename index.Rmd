...
**This book is still being developed. You may find typos in parts of the book.**
...
This package, and book, expect readers to have some familiarity with R [-@R-base]. However, we have created two Shiny apps (for the [`ANOVA_power`](http://shiny.ieis.tue.nl/anova_power/) & [`ANOVA_exact`](http://shiny.ieis.tue.nl/anova_exact/) functions respectively) to help use `Superpower` if you are not familiar with R.
