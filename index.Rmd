...
This package, and book, expect readers to have some familiarity with R [-@R-base]. However, we have created two Shiny apps (for the [`ANOVA_power`](https://aaroncaldwell.us/shiny/anova_power) & [`ANOVA_exact`](https://aaroncaldwell.us/shiny/anova_exact) functions respectively) to help use `Superpower` if you are not familiar with R.
