...
Currently, this pacakge only provides power analysis for ANOVA and for repeated measures MANOVA so all designs are defined by the `ANOVA_design` function.
