...
## Power and Effect sizes for ANOVA tests
##                    power effect_size
## anova_fruit           58    0.004884
## anova_hunger          64    0.005216
## anova_fruit:hunger    51    0.004574
## 
## Power and Effect sizes for contrasts
##                                                                  power
## p_fruit_apple_hunger_no hunger_fruit_apple_hunger_very hungry        6
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-101-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-104-1.pdf}
...
##                                                                                            effect_size
## p_Size_big_Color_green_CognitiveLoad_present_Size_big_Color_green_CognitiveLoad_absent        -0.20181
## p_Size_big_Color_green_CognitiveLoad_present_Size_big_Color_red_CognitiveLoad_present         -0.27526
## p_Size_big_Color_green_CognitiveLoad_present_Size_big_Color_red_CognitiveLoad_absent           0.10338
## p_Size_big_Color_green_CognitiveLoad_present_Size_small_Color_green_CognitiveLoad_present     -0.39875
## p_Size_big_Color_green_CognitiveLoad_present_Size_small_Color_green_CognitiveLoad_absent      -0.07594
## p_Size_big_Color_green_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_present       -0.18593
## p_Size_big_Color_green_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_absent        -0.41534
## p_Size_big_Color_green_CognitiveLoad_absent_Size_big_Color_red_CognitiveLoad_present          -0.07834
## p_Size_big_Color_green_CognitiveLoad_absent_Size_big_Color_red_CognitiveLoad_absent            0.30673
## p_Size_big_Color_green_CognitiveLoad_absent_Size_small_Color_green_CognitiveLoad_present      -0.19885
## p_Size_big_Color_green_CognitiveLoad_absent_Size_small_Color_green_CognitiveLoad_absent        0.12497
## p_Size_big_Color_green_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_present         0.01322
## p_Size_big_Color_green_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_absent         -0.21693
## p_Size_big_Color_red_CognitiveLoad_present_Size_big_Color_red_CognitiveLoad_absent             0.38017
## p_Size_big_Color_red_CognitiveLoad_present_Size_small_Color_green_CognitiveLoad_present       -0.11747
## p_Size_big_Color_red_CognitiveLoad_present_Size_small_Color_green_CognitiveLoad_absent         0.20134
## p_Size_big_Color_red_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_present          0.08863
## p_Size_big_Color_red_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_absent          -0.13777
## p_Size_big_Color_red_CognitiveLoad_absent_Size_small_Color_green_CognitiveLoad_present        -0.50469
## p_Size_big_Color_red_CognitiveLoad_absent_Size_small_Color_green_CognitiveLoad_absent         -0.17795
## p_Size_big_Color_red_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_present          -0.28919
## p_Size_big_Color_red_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_absent           -0.52047
## p_Size_small_Color_green_CognitiveLoad_present_Size_small_Color_green_CognitiveLoad_absent     0.32144
## p_Size_small_Color_green_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_present      0.21177
## p_Size_small_Color_green_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_absent      -0.01793
## p_Size_small_Color_green_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_present      -0.11155
## p_Size_small_Color_green_CognitiveLoad_absent_Size_small_Color_red_CognitiveLoad_absent       -0.33979
## p_Size_small_Color_red_CognitiveLoad_present_Size_small_Color_red_CognitiveLoad_absent        -0.22751
\end{verbatim}
...
\begin{Highlighting}[]
\CommentTok{# Power based on simulations}
\CommentTok{# ANOVA_power(design_result, nsims = nsims)}
\CommentTok{#Analytical power calculation}
\NormalTok{power_analytic <-}\StringTok{ }\KeywordTok{power_threeway_between}\NormalTok{(design_result)}
\NormalTok{power_analytic}\OperatorTok{$}\NormalTok{power_A}
\end{Highlighting}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-108-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-113-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-114-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-122-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu_from_ES <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(K, ES)\{ }\CommentTok{# provides the vector of population means for a given population ES and nr of groups}
\NormalTok{  f2 <-}\StringTok{ }\NormalTok{ES }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ES)}
  \ControlFlowTok{if}\NormalTok{ (K }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{) \{}
\NormalTok{  a <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(f2)}
\NormalTok{  muvec <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\NormalTok{a, a)}
\NormalTok{  \}}
  \ControlFlowTok{if}\NormalTok{ (K }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) \{}
\NormalTok{  a <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\DecValTok{3} \OperatorTok{*}\StringTok{ }\NormalTok{f2 }\OperatorTok{/}\StringTok{ }\DecValTok{2}\NormalTok{)}
\NormalTok{  muvec <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\NormalTok{a, }\DecValTok{0}\NormalTok{, a)}
\NormalTok{  \}}
  \ControlFlowTok{if}\NormalTok{ (K }\OperatorTok{==}\StringTok{ }\DecValTok{4}\NormalTok{) \{}
\NormalTok{  a <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(f2)}
\NormalTok{  muvec <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\NormalTok{a,}\OperatorTok{-}\NormalTok{a, a, a)}
\NormalTok{  \} }\CommentTok{# note: function gives error when K not 2,3,4. But we don't need other K.}
  \KeywordTok{return}\NormalTok{(muvec)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-130-1.pdf}
