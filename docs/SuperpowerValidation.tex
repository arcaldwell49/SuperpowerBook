...
\hypersetup{
  ...
  pdfauthor={Aaron R. Caldwell; Daniël Lakens; Chelsea M. Parlett-Pelleriti; Guy Prochilo; Frederik Aust},
  hidelinks,
...
\item
  Type II Error: failing to reject the null hypothesis when it is false (also known as false negatives or \(\beta\)).
\end{enumerate}
