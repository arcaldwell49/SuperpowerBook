...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#This function allows you to calculate f, d and eta squared following Cohen, 1988, p 277}
\CommentTok{# From Cohen, 1988, p 277}
\CommentTok{# The patterns are:}
\CommentTok{# I. Minimum variability: one mean at each end of d, the remaining k- 2 means all at the midpoint.}
...
\CommentTok{# For each of these patterns, there is a fixed relationship between f and d for any given number of means, k.}
...
\NormalTok{    f <-}\StringTok{ }\NormalTok{d}\OperatorTok{*}\KeywordTok{sqrt}\NormalTok{(}\DecValTok{1}\OperatorTok{/}\NormalTok{(}\DecValTok{2}\OperatorTok{*}\NormalTok{k))}
\NormalTok{    f2 <-}\StringTok{ }\NormalTok{f}\OperatorTok{^}\DecValTok{2}
...
\NormalTok{    k =}\StringTok{ }\KeywordTok{length}\NormalTok{(mu) }
\NormalTok{    d <-}\StringTok{ }\NormalTok{(}\KeywordTok{max}\NormalTok{(mu)}\OperatorTok{-}\KeywordTok{min}\NormalTok{(mu))}\OperatorTok{/}\NormalTok{sd}
\NormalTok{    f <-}\StringTok{ }\NormalTok{(d}\OperatorTok{/}\DecValTok{2}\NormalTok{)}\OperatorTok{*}\KeywordTok{sqrt}\NormalTok{((k}\OperatorTok{+}\DecValTok{1}\NormalTok{)}\OperatorTok{/}\NormalTok{(}\DecValTok{3}\OperatorTok{*}\NormalTok{(k}\DecValTok{-1}\NormalTok{)))}
\NormalTok{    f2 <-}\StringTok{ }\NormalTok{f}\OperatorTok{^}\DecValTok{2}
\NormalTok{    ES <-}\StringTok{ }\NormalTok{f2}\OperatorTok{/}\NormalTok{(f2}\OperatorTok{+}\DecValTok{1}\NormalTok{)}
\NormalTok{  \}}
...
\NormalTok{    k =}\StringTok{ }\KeywordTok{length}\NormalTok{(mu)}
\NormalTok{    d <-}\StringTok{ }\NormalTok{(}\KeywordTok{max}\NormalTok{(mu)}\OperatorTok{-}\KeywordTok{min}\NormalTok{(mu))}\OperatorTok{/}\NormalTok{sd}
\NormalTok{    f <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(k }\OperatorTok{%%}\StringTok{ }\DecValTok{2} \OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, }\FloatTok{.5}\OperatorTok{*}\NormalTok{d, d}\OperatorTok{*}\NormalTok{(}\KeywordTok{sqrt}\NormalTok{(k}\OperatorTok{^}\DecValTok{2-1}\NormalTok{)}\OperatorTok{/}\NormalTok{(}\DecValTok{2}\OperatorTok{*}\NormalTok{k)))}
\NormalTok{    f2 <-}\StringTok{ }\NormalTok{f}\OperatorTok{^}\DecValTok{2}
\NormalTok{    ES <-}\StringTok{ }\NormalTok{f2}\OperatorTok{/}\NormalTok{(f2}\OperatorTok{+}\DecValTok{1}\NormalTok{)}
\NormalTok{  \}}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-141-1.pdf}
...
\subsection{Two by two ANOVA, within design}\label{two-by-two-anova-within-design}}
...
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
\hline
A & 24.70891 & 0.0865385 & 0.3077935 & 1.8\\
\hline
B & 81.20654 & 0.3214286 & 0.6882472 & 9.0\\
\hline
A:B & 15.80878 & 0.0500000 & 0.2294157 & 1.0\\
\hline
\end{tabular}
\end{table}
...
We can simulate a Two-Way ANOVA with a specific alpha, sample size and effect size, to achieve a specified statistical power. We wil try to reproduce the power analysis by G*Power for an F-test from an ANOVA with a repeated measures, within-between interaction effect.
...
\caption{\label{tab:unnamed-chunk-165}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-167}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-170}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-172}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-194}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-205}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-208-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-224-2.pdf}
...
\caption{\label{tab:unnamed-chunk-238}ANOVA Results}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-242}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-258}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-262}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-267}ANOVA Results}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-268}Pairwise Results}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-271}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-283}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
\hline
A & 26.91752 & 0.0952381 & 0.3244428 & 2\\
\hline
B & 64.22587 & 0.2400000 & 0.5619515 & 6\\
\hline
A:B & 26.91752 & 0.0952381 & 0.3244428 & 2\\
\hline
\end{tabular}
\end{table}
...
\caption{\label{tab:unnamed-chunk-289}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-290-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-291-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-292-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-293-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-294-1.pdf}
