...
\hypersetup{
  ...
  pdfauthor={Aaron R. Caldwell, Daniël Lakens, and Chelsea M. Parlett-Pelleriti},
  hidelinks,
...
\author{Aaron R. Caldwell, Daniël Lakens, and Chelsea M. Parlett-Pelleriti}
\date{2021-01-25}
...
Currently, this package only provides power analysis for ANOVAs (and MANOVA for repeated measures) so all designs are currently defined by the \texttt{ANOVA\_design} function.
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-80-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-85-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-106-1.pdf}
...
\begin{verbatim}
## Warning in if (class(cors) == "numeric" & length(cors) == 1) {: the condition
## has length > 1 and only the first element will be used
\end{verbatim}

\begin{verbatim}
## Warning in if (class(cors) == "matrix") {: the condition has length > 1 and only
...
\caption{\label{tab:unnamed-chunk-142}MANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\caption{\label{tab:unnamed-chunk-147}Simulated MANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & pillai\_trace & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-150}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-152}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-163}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-165}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-173-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-176-1.pdf}
...
\caption{\label{tab:unnamed-chunk-177}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-179-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-199-1.pdf}
...
\caption{\label{tab:unnamed-chunk-199}ANOVA Results}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-199-2.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-207-1.pdf}
...
\caption{\label{tab:unnamed-chunk-207}ANOVA Results}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-213-1.pdf}
...
\caption{\label{tab:unnamed-chunk-213}ANOVA Results}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-217}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-219}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-222}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-223-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-224-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-225-1.pdf}
...
\caption{\label{tab:unnamed-chunk-230}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-231-1.pdf}
...
\caption{\label{tab:unnamed-chunk-233}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-2.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-3.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-4.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-5.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-234-6.pdf}
...
\caption{\label{tab:unnamed-chunk-237}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-240-1.pdf}
...
\caption{\label{tab:unnamed-chunk-242}ANOVA Results}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-243}Pairwise Results}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-254-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-258-1.pdf}
...
\caption{\label{tab:unnamed-chunk-259}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-260-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-261-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-263-1.pdf}
\pagebreak
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-264-1.pdf}
...
\caption{\label{tab:unnamed-chunk-271}Simulated MANOVA Result}
\centering
\begin{tabular}[t]{l|r}
\hline
  & power\\
...
\caption{\label{tab:unnamed-chunk-272}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-273}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-274-1.pdf}
...
\caption{\label{tab:unnamed-chunk-276}Simulated MANOVA Result}
\centering
\begin{tabular}[t]{l|r}
\hline
  & power\\
...
\hline
voice & condition\_cheerful & 21.80102\\
\hline
voice & condition\_sad & 10.39583\\
\hline
\end{tabular}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-311-1.pdf}
...
\caption{\label{tab:unnamed-chunk-313}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-315}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-322-1.pdf}
...
\caption{\label{tab:unnamed-chunk-324}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-326}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-333-1.pdf}
...
\caption{\label{tab:unnamed-chunk-335}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-337}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-339-1.pdf}
...
\caption{\label{tab:unnamed-chunk-341}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-343}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-350-1.pdf}
...
\caption{\label{tab:unnamed-chunk-352}Simulated ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-354}Exact ANOVA Result}
\centering
\begin{tabular}[t]{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-356-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-357-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-358-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-359-1.pdf}
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-360-1.pdf}
