...
This package, and book, expect readers to have some familiarity with R. However, we have created \href{http://shiny.ieis.tue.nl/anova_power/}{two Shiny apps} (for the \texttt{ANOVA\_power} \& \texttt{ANOVA\_exact} functions respectively) to help use these functions if you are not familiar with R.

In this book we will display a variety of ways the \texttt{Superpower} package can be used for power analysis and sample size planning for factorial experimental designs. We also included various examples of the performance of \texttt{Superpower} against other R packages (e.g., \texttt{pwr2ppl} and \texttt{pwr}) and statistical programs (such as G*Power or MOREpower). All uses of the \texttt{ANOVA\_power} function have been run with 10000 iterations (\texttt{nsims\ =\ 10000}). If you have any issues using \texttt{Superpower} or want to expand its capabilities please raise the issue on our \href{https://github.com/arcaldwell49/Superpower/issues}{GitHub} repository.
...
\caption{\label{tab:unnamed-chunk-158}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-160}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-168}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-170}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-181}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-183}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-187}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-189}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-192}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-217}ANOVA Results}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-217-2.pdf}
...
\caption{\label{tab:unnamed-chunk-248}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-255}Simulated ANOVA Result}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-260}ANOVA Results}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-261}Pairwise Results}
\centering
\begin{tabular}{l|r|r}
\hline
  & power & effect\_size\\
...
\caption{\label{tab:unnamed-chunk-264}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-269}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\caption{\label{tab:unnamed-chunk-282}Exact ANOVA Result}
\centering
\begin{tabular}{l|r|r|r|r}
\hline
  & power & partial\_eta\_squared & cohen\_f & non\_centrality\\
...
\includegraphics{SuperpowerValidation_files/figure-latex/unnamed-chunk-287-1.pdf}
